...
import Locationbasedalerts2Controller, {
  Props,
  configJSON,
} from "./Locationbasedalerts2Controller";

export default class Locationbasedalerts2 extends Locationbasedalerts2Controller {
